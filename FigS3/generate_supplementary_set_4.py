...
# 有MTBR
y_0001 = np.load('set4/noMTBRnoGTFT.npy', allow_pickle=True).tolist()

yi_0001 = np.load('set4/noMTBRnoGTFT_50.npy', allow_pickle=True).tolist()

# 无MTBR
y_001 = np.load('set4/noMTBR.npy', allow_pickle=True).tolist()

yi_001 = np.load('set4/noMTBRnoGTFT_50.npy', allow_pickle=True).tolist()


y_01 = np.load('set4/noGTFT.npy', allow_pickle=True).tolist()
yi_01 = np.load('set4/noGTFT_50.npy', allow_pickle=True).tolist()


y_04 = np.load('set4/All.npy', allow_pickle=True).tolist()
yi_04 = np.load('set4/All_50.npy', allow_pickle=True).tolist()
...
plot_evolution(ax_0001, x, y_0001[3], 'WSLS', '#00CED1', '-', alpha=1.0)

plot_evolution(ax_0001, x, y_0001[4], 'Hold-a-Grudge', '#8B0000', '-', alpha=1.0)
...
plot_evolution_repeat(ax_0001, x, yi_0001, 3, 'WSLS', color='#00CED1',linestyle="-")
plot_evolution_repeat(ax_0001, x, yi_0001, 4, 'Hold-a-Grudge', color='#8B0000', linestyle="-")
...
legend_elements = [
    ...
    Line2D([0], [0], color='#00CED1', linestyle='-', label='WSLS'),
    Line2D([0], [0], color='#8B0000', linestyle='-', label='Hold-a-Grudge'),
...
plot_evolution(ax_001, x, y_001[3], 'WSLS', '#00CED1', '-', alpha=1.0)

plot_evolution(ax_001, x, y_001[4], 'Hold-a-Grudge', '#8B0000', '-', alpha=1.0)
...
plot_evolution_repeat(ax_001, x, yi_001, 3, 'WSLS', color='#00CED1', linestyle="-")
plot_evolution_repeat(ax_001, x, yi_001, 4, 'Hold-a-Grudge', color='#8B0000', linestyle="-")
...
plot_evolution(ax_01, x, y_01[3], 'WSLS', '#00CED1', '-', alpha=1.0)

plot_evolution(ax_01, x, y_01[4], 'Hold-a-Grudge', '#8B0000', '-', alpha=1.0)
...
plot_evolution_repeat(ax_01, x, yi_01, 3, 'WSLS', color='#00CED1', linestyle="-")
plot_evolution_repeat(ax_01, x, yi_01, 4, 'Hold-a-Grudge', color='#8B0000', linestyle="-")
...
plot_evolution(ax_04, x, y_04[3], 'WSLS', '#00CED1', '-', alpha=1.0)

plot_evolution(ax_04, x, y_04[4], 'Hold-a-Grudge', '#8B0000', '-', alpha=1.0)
...
plot_evolution_repeat(ax_04, x, yi_04, 3, 'WSLS', color='#00CED1', linestyle="-")
plot_evolution_repeat(ax_04, x, yi_04, 4, 'Hold-a-Grudge', color='#8B0000', linestyle="-")
...
label_ax_a.text(-8.8, 8.5, 'a', fontsize=11, fontweight='bold', ha='center', va='center')
label_ax_b.text(-2.5, 8.5, 'b', fontsize=11, fontweight='bold', ha='center', va='center')
label_ax_c.text(-8.8, 1.5, 'c', fontsize=11, fontweight='bold', ha='center', va='center')
label_ax_d.text(-2.5, 1.5, 'd', fontsize=12, fontweight='bold', ha='center', va='center')
